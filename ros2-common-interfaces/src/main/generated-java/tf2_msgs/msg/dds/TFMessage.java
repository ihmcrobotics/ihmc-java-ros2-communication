...
public class TFMessage extends Packet<TFMessage> implements Settable<TFMessage>, EpsilonComparable<TFMessage>
{
   ...
   public TFMessage()
   {
      transforms_ = new us.ihmc.idl.IDLSequence.Object<geometry_msgs.msg.dds.TransformStamped>(100, geometry_msgs.msg.dds.TransformStamped.class,
                                                                                               new geometry_msgs.msg.dds.TransformStampedPubSubType());
   }
   ...
   public boolean epsilonEquals(TFMessage other, double epsilon)
   {
      ...
      else
      {
         ...
         {
            if (!this.transforms_.get(i).epsilonEquals(other.transforms_.get(i), epsilon))
               return false;
         }
      }
