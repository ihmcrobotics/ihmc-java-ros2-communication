...
public class TF2Error extends Packet<TF2Error> implements Settable<TF2Error>, EpsilonComparable<TF2Error>
{
   ...
   public boolean epsilonEquals(TF2Error other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.error_, other.error_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsStringBuilder(this.error_string_, other.error_string_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (!us.ihmc.idl.IDLTools.equals(this.error_string_, otherMyClass.error_string_))
         return false;
