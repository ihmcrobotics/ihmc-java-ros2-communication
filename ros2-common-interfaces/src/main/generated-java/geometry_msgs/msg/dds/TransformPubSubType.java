...
public class TransformPubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.euclid.transform.QuaternionBasedTransform>
{
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += geometry_msgs.msg.dds.Vector3PubSubType.getMaxCdrSerializedSize(current_alignment);current_alignment += geometry_msgs.msg.dds.QuaternionPubSubType.getMaxCdrSerializedSize(current_alignment);
