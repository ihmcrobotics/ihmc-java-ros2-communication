...
public class BoundedArrayNested implements Settable<BoundedArrayNested>, EpsilonComparable<BoundedArrayNested>
{
   public us.ihmc.idl.IDLSequence.Object<test_msgs.msg.dds.Primitives> primitive_values_;

   public BoundedArrayNested()
   {
      primitive_values_ = new us.ihmc.idl.IDLSequence.Object<test_msgs.msg.dds.Primitives>(4, test_msgs.msg.dds.Primitives.class,
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof BoundedArrayNested))
         return false;
