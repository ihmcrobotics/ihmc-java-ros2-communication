...
public class StaticArrayPrimitives extends Packet<StaticArrayPrimitives> implements Settable<StaticArrayPrimitives>, EpsilonComparable<StaticArrayPrimitives>
{
   ...
   public boolean epsilonEquals(StaticArrayPrimitives other, double epsilon)
   {
      ...
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsBoolean(this.bool_values_[i23], other.bool_values_[i23], epsilon)) return false;

      }

      for(int i25 = 0; i25 < byte_values_.length; ++i25)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.byte_values_[i25], other.byte_values_[i25], epsilon)) return false;
      }

      for(int i27 = 0; i27 < char_values_.length; ++i27)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.char_values_[i27], other.char_values_[i27], epsilon)) return false;
      }

      for(int i29 = 0; i29 < float32_values_.length; ++i29)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.float32_values_[i29], other.float32_values_[i29], epsilon)) return false;
      }

      for(int i31 = 0; i31 < float64_values_.length; ++i31)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.float64_values_[i31], other.float64_values_[i31], epsilon)) return false;
      }

      for(int i33 = 0; i33 < int8_values_.length; ++i33)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.int8_values_[i33], other.int8_values_[i33], epsilon)) return false;
      }

      for(int i35 = 0; i35 < uint8_values_.length; ++i35)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.uint8_values_[i35], other.uint8_values_[i35], epsilon)) return false;
      }

      for(int i37 = 0; i37 < int16_values_.length; ++i37)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.int16_values_[i37], other.int16_values_[i37], epsilon)) return false;
      }

      for(int i39 = 0; i39 < int32_values_.length; ++i39)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.int32_values_[i39], other.int32_values_[i39], epsilon)) return false;
      }

      for(int i41 = 0; i41 < string_values_.length; ++i41)
      {
                if (!us.ihmc.idl.IDLTools.epsilonEqualsStringBuilder(this.string_values_[i41], other.string_values_[i41], epsilon)) return false;}
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof StaticArrayPrimitives)) return false;

      StaticArrayPrimitives otherMyClass = (StaticArrayPrimitives) other;

      for(int i43 = 0; i43 < bool_values_.length; ++i43)
      {
                if(this.bool_values_[i43] != otherMyClass.bool_values_[i43]) return false;

      }
      for(int i45 = 0; i45 < byte_values_.length; ++i45)
      {
                if(this.byte_values_[i45] != otherMyClass.byte_values_[i45]) return false;

      }
      for(int i47 = 0; i47 < char_values_.length; ++i47)
      {
                if(this.char_values_[i47] != otherMyClass.char_values_[i47]) return false;

      }
      for(int i49 = 0; i49 < float32_values_.length; ++i49)
      {
                if(this.float32_values_[i49] != otherMyClass.float32_values_[i49]) return false;

      }
      for(int i51 = 0; i51 < float64_values_.length; ++i51)
      {
                if(this.float64_values_[i51] != otherMyClass.float64_values_[i51]) return false;

      }
      for(int i53 = 0; i53 < int8_values_.length; ++i53)
      {
                if(this.int8_values_[i53] != otherMyClass.int8_values_[i53]) return false;

      }
      for(int i55 = 0; i55 < uint8_values_.length; ++i55)
      {
                if(this.uint8_values_[i55] != otherMyClass.uint8_values_[i55]) return false;

      }
      for(int i57 = 0; i57 < int16_values_.length; ++i57)
      {
                if(this.int16_values_[i57] != otherMyClass.int16_values_[i57]) return false;

      }
      for(int i59 = 0; i59 < int32_values_.length; ++i59)
      {
                if(this.int32_values_[i59] != otherMyClass.int32_values_[i59]) return false;

      }
      for(int i61 = 0; i61 < string_values_.length; ++i61)
      {
                if (!us.ihmc.idl.IDLTools.equals(this.string_values_[i61], otherMyClass.string_values_[i61])) return false;}
   ...
   public java.lang.String toString()
   {
      ...
      builder.append(java.util.Arrays.toString(this.bool_values_));      builder.append(", ");
      builder.append("byte_values=");
      builder.append(java.util.Arrays.toString(this.byte_values_));      builder.append(", ");
      builder.append("char_values=");
      builder.append(java.util.Arrays.toString(this.char_values_));      builder.append(", ");
      builder.append("float32_values=");
      builder.append(java.util.Arrays.toString(this.float32_values_));      builder.append(", ");
      builder.append("float64_values=");
      builder.append(java.util.Arrays.toString(this.float64_values_));      builder.append(", ");
      builder.append("int8_values=");
      builder.append(java.util.Arrays.toString(this.int8_values_));      builder.append(", ");
      builder.append("uint8_values=");
      builder.append(java.util.Arrays.toString(this.uint8_values_));      builder.append(", ");
      builder.append("int16_values=");
      builder.append(java.util.Arrays.toString(this.int16_values_));      builder.append(", ");
      builder.append("int32_values=");
      builder.append(java.util.Arrays.toString(this.int32_values_));      builder.append(", ");
