...
/**
 * Topic data type of the struct "DynamicArrayPrimitives" defined in "DynamicArrayPrimitives_.idl". Use this class to provide the TopicDataType to a Participant.
 *
 * This file was automatically generated from DynamicArrayPrimitives_.idl by us.ihmc.idl.generator.IDLGenerator.
 * Do not update this file directly, edit DynamicArrayPrimitives_.idl instead.
 */
public class DynamicArrayPrimitivesPubSubType implements us.ihmc.pubsub.TopicDataType<test_msgs.msg.dds.DynamicArrayPrimitives>
{
   public static final java.lang.String name = "test_msgs::msg::dds_::DynamicArrayPrimitives_";
   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   public DynamicArrayPrimitivesPubSubType()
   {
   ...
   public final static int getCdrSerializedSize(test_msgs.msg.dds.DynamicArrayPrimitives data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(test_msgs.msg.dds.DynamicArrayPrimitives data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void read(test_msgs.msg.dds.DynamicArrayPrimitives data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void staticCopy(test_msgs.msg.dds.DynamicArrayPrimitives src, test_msgs.msg.dds.DynamicArrayPrimitives dest)
   {
      dest.set(src);
   }

   @Override
   public void serialize(test_msgs.msg.dds.DynamicArrayPrimitives data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, test_msgs.msg.dds.DynamicArrayPrimitives data) throws java.io.IOException
   {
   ...
   @Override
   public final void serialize(test_msgs.msg.dds.DynamicArrayPrimitives data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, test_msgs.msg.dds.DynamicArrayPrimitives data)
   {
   ...
   @Override
   public test_msgs.msg.dds.DynamicArrayPrimitives createData()
   {
      return new test_msgs.msg.dds.DynamicArrayPrimitives();
   }
   ...
   public void serialize(test_msgs.msg.dds.DynamicArrayPrimitives data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(test_msgs.msg.dds.DynamicArrayPrimitives data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }

   public void copy(test_msgs.msg.dds.DynamicArrayPrimitives src, test_msgs.msg.dds.DynamicArrayPrimitives dest)
   {
      staticCopy(src, dest);
   }

   @Override
   public DynamicArrayPrimitivesPubSubType newInstance()
   {
      return new DynamicArrayPrimitivesPubSubType();
   }
}
