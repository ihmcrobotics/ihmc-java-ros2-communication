...
public class StaticArrayNested implements Settable<StaticArrayNested>, EpsilonComparable<StaticArrayNested>
{
   ...
   public boolean epsilonEquals(StaticArrayNested other, double epsilon)
   {
      ...
      {
         if (!this.primitive_values_[i5].epsilonEquals(other.primitive_values_[i5], epsilon))
            return false;
      }
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof StaticArrayNested))
         return false;
