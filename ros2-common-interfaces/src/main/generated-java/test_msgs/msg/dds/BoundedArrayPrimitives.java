...
public class BoundedArrayPrimitives extends Packet<BoundedArrayPrimitives>
      implements Settable<BoundedArrayPrimitives>, EpsilonComparable<BoundedArrayPrimitives>
{
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof BoundedArrayPrimitives))
         return false;
