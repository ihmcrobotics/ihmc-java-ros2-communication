...
public class MultiDOFJointTrajectoryPoint extends Packet<MultiDOFJointTrajectoryPoint> implements Settable<MultiDOFJointTrajectoryPoint>, EpsilonComparable<MultiDOFJointTrajectoryPoint>
{
   ...
   public MultiDOFJointTrajectoryPoint()
   {
      ...
      velocities_ = new us.ihmc.idl.IDLSequence.Object<geometry_msgs.msg.dds.Twist> (10000000, new geometry_msgs.msg.dds.TwistPubSubType());
      accelerations_ = new us.ihmc.idl.IDLSequence.Object<geometry_msgs.msg.dds.Twist> (10000000, new geometry_msgs.msg.dds.TwistPubSubType());
