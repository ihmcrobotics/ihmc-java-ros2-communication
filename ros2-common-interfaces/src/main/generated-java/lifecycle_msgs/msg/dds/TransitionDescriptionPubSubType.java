...
public class TransitionDescriptionPubSubType implements us.ihmc.pubsub.TopicDataType<lifecycle_msgs.msg.dds.TransitionDescription>
{
   ...
   @Override
   public void serialize(lifecycle_msgs.msg.dds.TransitionDescription data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, lifecycle_msgs.msg.dds.TransitionDescription data)
         throws java.io.IOException
   {
