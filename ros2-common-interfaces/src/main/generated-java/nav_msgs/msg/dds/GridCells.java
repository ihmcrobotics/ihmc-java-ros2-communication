...
public class GridCells implements Settable<GridCells>, EpsilonComparable<GridCells>
{
    public GridCells()
    {
        	...
        	cells_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.euclid.tuple3D.Point3D> (100, us.ihmc.euclid.tuple3D.Point3D.class, new geometry_msgs.msg.dds.PointPubSubType());
