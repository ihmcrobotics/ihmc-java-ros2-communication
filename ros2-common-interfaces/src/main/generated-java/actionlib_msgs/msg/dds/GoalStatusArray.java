...
public class GoalStatusArray extends Packet<GoalStatusArray> implements Settable<GoalStatusArray>, EpsilonComparable<GoalStatusArray>
{
   ...
   public GoalStatusArray()
   {
      ...
      status_list_ = new us.ihmc.idl.IDLSequence.Object<actionlib_msgs.msg.dds.GoalStatus> (100, actionlib_msgs.msg.dds.GoalStatus.class, new actionlib_msgs.msg.dds.GoalStatusPubSubType());
