...
public class CustomBoi implements Settable<CustomBoi>, EpsilonComparable<CustomBoi>
{
   ...
   public boolean epsilonEquals(CustomBoi other, double epsilon)
   {
      ...
      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.x_, other.x_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.y_, other.y_, epsilon))
         return false;

      if (!us.ihmc.idl.IDLTools.epsilonEqualsPrimitive(this.z_, other.z_, epsilon))
         return false;
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof CustomBoi))
         return false;

      CustomBoi otherMyClass = (CustomBoi) other;

      if (this.x_ != otherMyClass.x_)
         return false;

      if (this.y_ != otherMyClass.y_)
         return false;

      if (this.z_ != otherMyClass.z_)
         return false;
